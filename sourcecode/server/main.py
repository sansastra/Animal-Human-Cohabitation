...
class Stream_handler:
    def __init__(self):
        ...
        self.file_name = time.strftime("%Y_%m_%d-%H_%M_%S")
        self.file_data = []
...
class ClientThread(Thread):
    ...
    def __init__(self,source_addr):
        ...
        self.rx_queue = Queue(maxsize=2000)
        ...
        while True :
            try:
                ...
                if   flag == 1:#received notification from sensor node
                    ...
                    # choose command here
                elif flag == 3:#received classification result from sensor
                    ...
                    if file_transfer_done:
                        ...
                        ml_result = classify(__stream.file_name)
                        # @TODO : send order to sensor based on ML output.
